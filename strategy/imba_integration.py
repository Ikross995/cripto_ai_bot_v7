...
class IMBASignalIntegration:
    ...
    def __init__(self, config: Config):
        ...
        self.aggregator = IMBASignalAggregator(
            ...
            lstm_weight=0.35,
            alt_influence=config.alt_influence
        )
        ...
        logger.info(f"  Trend ADX threshold: {config.trend_adx_threshold}")
        logger.info(f"  Flat ADX threshold: {config.flat_adx_threshold}")
