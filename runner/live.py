                    ...
                    if order_status == 'FILLED' and executed_qty > 0:
                        ...
                        if self.adaptive_learning:
                            try:
                                ...
                                # Create a trade record for the opening (will be updated on close)
                                ...
                                self.logger.debug("🤖 [LEARNING] Trade opening recorded for analysis")
                            except Exception as learning_e:
                                self.logger.warning(f"🤖 [LEARNING] Failed to record trade opening: {learning_e}")
